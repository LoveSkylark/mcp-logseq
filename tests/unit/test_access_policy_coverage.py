...
EXPECTED_POLICIES = {
    ...
    tools.UpsertNodesToolHandler: set(),
    tools.GetPageDataToolHandler: set(),
    tools.ListTagsToolHandler: set(),
    tools.ListPropertiesToolHandler: set(),
    tools.SearchBlocksToolHandler: set(),
    tools.GetPropertyToolHandler: set(),
    tools.UpsertPropertyToolHandler: set(),
    tools.RemovePropertyToolHandler: set(),
    tools.GetBlockPropertiesToolHandler: set(),
    tools.GetBlockPropertyToolHandler: set(),
    tools.UpsertBlockPropertyToolHandler: set(),
    tools.RemoveBlockPropertyToolHandler: set(),
    tools.GetTagToolHandler: set(),
    tools.GetTagObjectsToolHandler: set(),
    tools.GetTagsByNameToolHandler: set(),
    tools.CreateTagToolHandler: set(),
    tools.AddBlockTagToolHandler: set(),
    tools.RemoveBlockTagToolHandler: set(),
    tools.ListNodesToolHandler: set(),
    tools.ListTasksToolHandler: set(),
    tools.ListAssetsToolHandler: set(),
    tools.AddTagPropertyToolHandler: set(),
    tools.RemoveTagPropertyToolHandler: set(),
    tools.AddTagExtendsToolHandler: set(),
    tools.RemoveTagExtendsToolHandler: set(),
}
